...
namespace Controllers.UserController
{
    ...
    public class UserMoviesController : Controller
    {
        ...
        public UserMoviesController(ApplicationDbContext context, IWebHostEnvironment webHostEnvironment)
        {
            _context = context;
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var movie = await _context.Movies
                ...
                .Include(m => m.Reviews.Where(r => r.IsApproved)).ThenInclude(r => r.ReviewReactions)
