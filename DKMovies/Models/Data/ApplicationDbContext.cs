...
namespace DKMovies.Models.Data;
    public class ApplicationDbContext : DbContext
    {
        ...
        public DbSet<TheaterImage> TheaterImages { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TheaterImage>().ToTable("TheaterImages");
            ...
            modelBuilder.Entity<ReviewReaction>().ToTable("ReviewReactions");
