...
-- USERS
INSERT INTO Users (Username, Email, PasswordHash, FullName, Phone, BirthDate, Gender, ProfileImagePath, EmailConfirmed) VALUES
('john_doe', 'john@example.com', 'pmWkWSBCL51Bfkhn79xPuKBKHz//H6B+mY6G9/eieuM=', 'John Doe', '1111111111', '1990-01-01', 'Male', 'men/0.jpg', 1),
('jane_doe', 'jane@example.com', 'pmWkWSBCL51Bfkhn79xPuKBKHz//H6B+mY6G9/eieuM=', 'Jane Doe', '2222222222', '1992-05-05', 'Female', 'women/0.jpg', 1),
('alex_lee', 'alex@example.com', 'pmWkWSBCL51Bfkhn79xPuKBKHz//H6B+mY6G9/eieuM=', 'Alex Lee', '3333333333', '1988-11-20', 'Other', 'men/1.jpg', 1);
...
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=zSWdZVtXT7E' 
WHERE Title = 'Interstellar';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=EXeTwQWrcwY' 
WHERE Title = 'The Dark Knight';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=L3pk_TBkihU' 
WHERE Title = 'Tenet';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=T7O7BtBnsG4' 
WHERE Title = 'Dunkirk';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=QWBKEmWWL38' 
WHERE Title = 'Jurassic Park';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=gG22XNhtnoY'
WHERE Title = 'Schindler''s List';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=U1fu_sA7XhE' 
WHERE Title = 'Jaws';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=9CiW_DgxCnQ' 
WHERE Title = 'Saving Private Ryan';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=s7EdQ4FqbhY' 
WHERE Title = 'Pulp Fiction';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=0fUCuvNlOCg' 
WHERE Title = 'Django Unchained';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=KnrRy6kSFF0' 
WHERE Title = 'Inglourious Basterds';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=ByXuk9QqQkk' 
WHERE Title = 'Spirited Away';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=92a7Hj0ijLs' 
WHERE Title = 'My Neighbor Totoro';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=iwROgK94zcM' 
WHERE Title = 'Howl''s Moving Castle';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=4OiMOHRDs14' 
WHERE Title = 'Princess Mononoke';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=5xH0HfJHsaY' 
WHERE Title = 'Parasite';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=nX5PwfEMBM0' 
WHERE Title = 'Snowpiercer';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=xrLY0wO06l4' 
WHERE Title = 'The Host';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=0n_HQwQU8ls' 
WHERE Title = 'Memories of Murder';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=AjCebKn4iic' 
WHERE Title = 'Okja';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=8g18jFHCLXk' 
WHERE Title = 'Dune';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=tFMo3UJ4B4g' 
WHERE Title = 'Arrival';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=gCcx85zbxz4' 
WHERE Title = 'Blade Runner 2049';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=bpXfcTF6iVk' 
WHERE Title = 'Prisoners';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=G8tlEcnrGnU' 
WHERE Title = 'Sicario';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=kVrqfYjkTdQ' 
WHERE Title = 'Titanic';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=5PSNL1qE6VY' 
WHERE Title = 'Avatar';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=CRRlbK5w8AE' 
WHERE Title = 'Terminator 2: Judgment Day';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=oSeQQlaCZgU' 
WHERE Title = 'Aliens';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=7cCVYAcIIAo' 
WHERE Title = 'The Abyss';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=2ilzidi_J8Q' 
WHERE Title = 'GoodFellas';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=iszwuX1AK6A' 
WHERE Title = 'The Wolf of Wall Street';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=WHXxVmeGQUc' 
WHERE Title = 'The Irishman';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=T5IligQP7Fo' 
WHERE Title = 'Taxi Driver';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=EJXDMwGWhoA' 
WHERE Title = 'Casino';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=0ndBL50MhrU' 
WHERE Title = 'Lady Bird';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=AST2-4db4ic' 
WHERE Title = 'Little Women';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=pBk4NYhWNMM' 
WHERE Title = 'Barbie';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=tL4McUzXfFI' 
WHERE Title = 'Jojo Rabbit';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=ue80QwXMRHg' 
WHERE Title = 'Thor: Ragnarok';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=dPaU4Gymt3E' 
WHERE Title = 'Hunt for the Wilderpeople';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=IAZEWtyhpes' 
WHERE Title = 'What We Do in the Shadows';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=6BS27ngZtxg' 
WHERE Title = 'Roma';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=OiTiKOy59o4' 
WHERE Title = 'Gravity';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=2VT2apoX90o' 
WHERE Title = 'Children of Men';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=VwErvYgoH70' 
WHERE Title = 'Harry Potter and the Prisoner of Azkaban';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=eogpIG53Cis' 
WHERE Title = 'Blade Runner';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=P5ieIbInFpg' 
WHERE Title = 'Gladiator';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=oSeQQlaCZgU' 
WHERE Title = 'Alien';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=ej3ioOneTy8' 
WHERE Title = 'The Martian';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=2GfBkC3qs78' 
WHERE Title = 'Black Hawk Down';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=1Q8fG0TtVAY' 
WHERE Title = 'Wonder Woman';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=sfM7_JLk-84' 
WHERE Title = 'Wonder Woman 1984';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=hA-lmaz4AM8' 
WHERE Title = 'Monster';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=1Fg5iWmQjwk' 
WHERE Title = 'The Grand Budapest Hotel';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=_eOI3AamSm8' 
WHERE Title = 'Moonrise Kingdom';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=n2igjYFojUo' 
WHERE Title = 'Fantastic Mr. Fox';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=caMgokYWboU' 
WHERE Title = 'The Royal Tenenbaums';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=dt__kig8PVU' 
WHERE Title = 'Isle of Dogs';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=0pdqf4P9MB8' 
WHERE Title = 'La La Land';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=7d_jQycdQGo' 
WHERE Title = 'Whiplash';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=PSoRx87OO6k' 
WHERE Title = 'First Man';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=5muQK7CuFtY' 
WHERE Title = 'Babylon';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=DzfpyUB60YY' 
WHERE Title = 'Get Out';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=hNCmb-4oXJA' 
WHERE Title = 'Us';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=In8fuzj3gck' 
WHERE Title = 'Nope';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=6sxCFZ8_d84' 
WHERE Title = 'Nomadland';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=AlrWRttLTkg' 
WHERE Title = 'The Rider';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=x_me3xsvDgk' 
WHERE Title = 'Eternals';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=1TSidCNA7mQ' 
WHERE Title = 'King Kong';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=a_po0Zpbnc4' 
WHERE Title = 'Heavenly Creatures';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=jVZRnnVSQ8k' 
WHERE Title = 'Pan''s Labyrinth';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=XFYWazblaUA' 
WHERE Title = 'The Shape of Water';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=oquZifON8Eg' 
WHERE Title = 'Crimson Peak';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=dt5g5_1cKVk' 
WHERE Title = 'Hellboy';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=Q81Yf46Oj3s' 
WHERE Title = 'Nightmare Alley';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=hEJnMQG9ev8' 
WHERE Title = 'Mad Max: Fury Road';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=UlwtiOyaoo0' 
WHERE Title = 'Mad Max 2';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=yuzXPzgBDvo' 
WHERE Title = 'Babe';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=NF75QyhWmBs' 
WHERE Title = 'Happy Feet';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=FTjG-Aux_yQ' 
WHERE Title = 'Apocalypse Now';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=elJL5D6HTvA' 
WHERE Title = 'The Conversation';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=cpAfqCUaVwg' 
WHERE Title = 'Dracula';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=oR_e9y-bka0' 
WHERE Title = '2001: A Space Odyssey';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=S014oGZiSdI' 
WHERE Title = 'The Shining';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=T54uZPI4Z8A' 
WHERE Title = 'A Clockwork Orange';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=n2i917l5RFc' 
WHERE Title = 'Full Metal Jacket';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=xgVo96JaqeM' 
WHERE Title = 'Eyes Wide Shut';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=TBHIO60whNw' 
WHERE Title = 'Edward Scissorhands';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=ickbVzajrk0' 
WHERE Title = 'Beetlejuice';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=mqqft2x_Aa4' 
WHERE Title = 'Batman';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=AGACeWVdFqo' 
WHERE Title = 'Corpse Bride';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=D0kiS4ROWkQ' 
WHERE Title = 'Big Fish';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=bLvqoHBptjg' 
WHERE Title = 'Forrest Gump';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=qGuOZPwLayY' 
WHERE Title = 'Cast Away';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=TQhRqtt-Fpo' 
WHERE Title = 'The Polar Express';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=R8weLPF4qBQ' 
WHERE Title = 'Platoon';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=w16bYZ-4nmE' 
WHERE Title = 'JFK';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=OwNNUVbdfzI' 
WHERE Title = 'Born on the Fourth of July';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=XpLKNclOtLg' 
WHERE Title = 'Natural Born Killers';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=EajIlG_OCvw' 
WHERE Title = 'A Beautiful Mind';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=KtEIMC58sZo' 
WHERE Title = 'Apollo 13';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=4XA73ni9eVs' 
WHERE Title = 'Rush';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=5sU9MT8829k' 
WHERE Title = 'The Da Vinci Code';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=DlbHzcH4VJY' 
WHERE Title = 'Cinderella Man';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=36mnx8dBbGE' 
WHERE Title = 'Casino Royale';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=lcOqUE0u1LM' 
WHERE Title = 'GoldenEye';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=abwtRFZx8Rs' 
WHERE Title = 'The Mask of Zorro';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=om9YCk7ufHs' 
WHERE Title = 'The Foreigner';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=C4QUhbywIFo' 
WHERE Title = 'Edge of Darkness';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=S-1QgOMQ-ls' 
WHERE Title = 'Saw';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=k10ETZ41q5o' 
WHERE Title = 'The Conjuring';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=zuZnRUcoWos' 
WHERE Title = 'Insidious';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=Skpu5HaVkOc' 
WHERE Title = 'Furious 7';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=8-8eEniEfgU' 
WHERE Title = 'Armageddon';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=Xm12NSa8jsM' 
WHERE Title = 'Bad Boys';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=a3qcNyjj9ZQ' 
WHERE Title = 'The Rock';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=YqNYrYUiMfg' 
WHERE Title = '1917';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=6kw1UVovByw' 
WHERE Title = 'Skyfall';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=ashLaclKCik' 
WHERE Title = 'Spectre';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=OreveBlLfho' 
WHERE Title = 'Road to Perdition';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=3-ZP95NF_Wk' 
WHERE Title = 'The Sixth Sense';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=fNeCB2ALNoA' 
WHERE Title = 'Unbreakable';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=dUw26F0WfLg' 
WHERE Title = 'Signs';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=84TouqfIsiI' 
WHERE Title = 'Split';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=sTGyhwvdY6k' 
WHERE Title = 'The Village';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=BdJKm16Co6M' 
WHERE Title = 'Fight Club';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=znmZoVkCjpI' 
WHERE Title = 'Se7en';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=2-_-1nJf8Vg' 
WHERE Title = 'Gone Girl';
UPDATE Movies SET TrailerUrl = 'https://www.youtube.com/watch?v=lB95KLmpLR4' 
